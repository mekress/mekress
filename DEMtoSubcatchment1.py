...
# Description: 
#   This is generated by Model Builder and has been revised to work in a stand alone 
#   environment.  It was helpful in developing arcpy routines which do run as stand alone.
#   One of the key changes, which was not due to Model Builder but my configuration,
#   is the fact that One-Drive was used for the default data storage for arcMap.
# ---------------------------------------------------------------------------
